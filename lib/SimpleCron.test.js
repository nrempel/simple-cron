...
describe('SimpleCron', () => {
  describe('constructor', () => {
    it('Should initialize correctly with deafults', () => {
      ...
      expect(cron.threshold).toBe(100);
    });

    it('Should initialize correctly with threshold', () => {
      const threshold = 20;
      const otherCron = new SimpleCron({ threshold });
      expect(otherCron.threshold).toBe(threshold);
    });
